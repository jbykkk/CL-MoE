...
deepspeed --include localhost:0,1 --master_port 29600 llava/train/train_mem_MOE.py \
    ...
    --previous_task_model_path ./checkpoints/CL4VQA_1_5/location/llava-1.5-7b-lora \
    ...
    --bf16 True \
    --output_dir ./checkpoints/CL4VQA_1_5/Only_Pretrain_1.5_MOE_5/judge/llava-1.5-7b-lora \
    --num_train_epochs 1 \
