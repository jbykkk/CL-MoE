...
deepspeed --include localhost:0,1 --master_port 29600 llava/train/train_mem_MOE.py \
    ...
    --previous_task_model_path ./checkpoints/CL4VQA_1_2/subcategory/llava-1.5-7b-lora \
    --version $PROMPT_VERSION \
    --data_path CL4VQA/train/train_q_causal.json \
    --image_folder data/ \
    ...
    --bf16 True \
    --output_dir ./checkpoints/CL4VQA_1_2/Only_Pretrain_1.5_MOE_1_2/causal/llava-1.5-7b-lora \
    --num_train_epochs 1 \
