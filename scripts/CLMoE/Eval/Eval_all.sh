...
#   bash Eval_all.sh onehalf # eval 1/2-data CL-MoE
...
elif [ "$1" = "onehalf" ] || [ "$1" = "1_2" ]; then
    STAGE='Finetune_1_2'
    MODELPATH='/home/data1/lyk/Experiments/CL-MoE/checkpoints/CL4VQA_1_2/causal/llava-1.5-7b-lora'
else
    STAGE='Finetune'
